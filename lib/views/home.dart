...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Future fetchNews() async {
    ...
    response = await http.get(Uri.parse(
        "https://fly.sportsdata.io/v3/nba/scores/json/News?key=74019eae9e404d2e9b9e5b707922b7f9"));
